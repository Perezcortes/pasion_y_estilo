...
import { db } from '../../../../lib/mysql' // Usa alias si tienes configurado tsconfig.json
...
export async function DELETE(
  ...
  try {
    ...
    if (result.affectedRows === 0) {
      return NextResponse.json({ success: false, error: 'No se pudo eliminar el item' }, { status: 500 })
    }
