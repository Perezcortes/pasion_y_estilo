...
export default function Navbar() {
    ...
    const [rolCliente, setRolCliente] = useState<string | null>(null)
    ...
    // Solo mostrar nombre y menú si rol es 'CLIENTE' o '1' (ajusta según tu sistema)
    const mostrarMenuCliente = rolCliente === 'CLIENTE' || rolCliente === '1'
        ...
        >
            <div className="container mx-auto flex items-center justify-between px-4 py-3">
                ...
                <div className="flex items-center ml-6">
                    {mostrarMenuCliente && nombreCliente ? (
                        ...
                        // Si no es cliente o no hay nombre, mostrar botón Ingresar
                        <Link
                            href="/login"
                            className="flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 rounded-full text-white transition-all duration-300"
                        >
